...
#$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)         ))
$(eval $(call IMG2SP, SET_FOLDER      , src/assets/map/ ))
$(eval $(call IMG2SP, SET_IMG_FORMAT  , zgtiles            ))
$(eval $(call IMG2SP, CONVERT, img/set_sin_black_f.png , 8, 8, set32, newPalette))

############## COCOS
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
$(eval $(call IMG2SP, SET_FOLDER      , src/assets/map/           ))
$(eval $(call IMG2SP, CONVERT         , img/cocos.png , 8, 8, cocos))

############## PLAYERS
#$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
#$(eval $(call IMG2SP, SET_FOLDER      , src/assets/sprites/           ))
#$(eval $(call IMG2SP, CONVERT         , img/player14.png , 14, 14, player))
#$(eval $(call IMG2SP, CONVERT         , img/pacman14.png , 14, 14, pacman))

$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
$(eval $(call IMG2SP, SET_FOLDER      , src/assets/sprites/           ))
$(eval $(call IMG2SP, CONVERT         , img/player12.png , 12, 14, player12))
$(eval $(call IMG2SP, CONVERT         , img/pacman12.png , 12, 14, pacman12))
$(eval $(call IMG2SP, CONVERT         , img/logo.png , 100, 20, logo))


#PALETTE= {1 24 20 6 26 0 2 8 10 12 14 16 18 22 24 16}
#$(eval $(call IMG2SPRITES,img/player.png,0,player,16,16,$(PALETTE),,src/assets/sprites/,hwpalette))
#$(eval $(call IMG2SPRITES,img/player14.png,0,player,14,14,$(PALETTE),,src/assets/sprites/,hwpalette))
#$(eval $(call IMG2SPRITES,img/pacman14.png,0,pacman,14,14,$(PALETTE),,src/assets/sprites/,hwpalette))
